...
The workflow in R is summarised in Figure \ref{fig06} which includes the following steps of data processing: . The 2D and 3D maps showing the topography and geomorphic structure of the Wadi Qena region were prepared using the Generic Mapping Tools \cite{Wessel} by the existing methods of cartographic scripting \cite{Lemenkova202228}.
