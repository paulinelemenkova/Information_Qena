...
Extracting information from the satellite images on drainage wadi network enables to define basin boundaries and stream channel density, perform analysis of slope and flow directions for retrospective analysis of the hydrological processes in the past to better analyse current geologic setting \cite{abdelkareem2013integration,AbdelkareemFarouk}. Further, essential geographic information collected from the satellite imagery is useful for operative flash flood monitoring through integration of the data on physiographic features. Other applications of the remote sensing data include modelling lithological, geological, and structural features \cite{BESHR2021999}, mapping mineral resources \cite{Kamal} and detecting wadi channels based on the combination of the topographic maps and satellite images \cite{Moubark}.

The region of Qena Bend, situated in Upper Egypt, is affected by the hydrology of the Nile River and the influence of the climate characteristics of Eastern Desert. A special feature of such climate includes the occasional extreme flash floods -- one of the most severe natural disasters that are caused by the torrential rainfalls and result in the disastrous surface runoff \cite{Moawad}. At the same time, the geomorphology of the area is notable for complex drainage network of wadi aquifer systems \cite{Alkholy,AbdelMoneim}. This presents the interrelated complex of the ephemeral rivers dry during most of the year and containing water during flash floods and heavy rains \cite{ElFakharany}. The cumulative effects from wadi network and arid and semi-arid climate of the Eastern Desert region results in occasional flash flood events and irregular sand dust storms with different durations and intensities.

Flash floods occurs in diverse regions across in Egypt including Upper Egypt with Eastern Desert \cite{ElHaddad,Elsadek}, southern Red Sea Coast \cite{Abdalla2014}, Sinai Peninsula \cite{ELOSTA2021101522} and Gulf of Suez \cite{AbdelLattif}. The social consequences of flash floods inlcude damaged infrustructure, trasport ways and buildings, and occasioanl victims \cite{Moawad}.
