...
Nevertheless, soil properties differs according to the soil types that are reflected in the presence of organic carbon, moisture percentage, and specific geochemical characteristics of agricultural lands (contamination, contents of sulphides, fertilisers, pesticides and level of salinity). Likewise, reflectance spectra of diverse rock types differs significantly, which enables to discriminate them on the satellite images using algorithms of computer vision. Therefore, we presented various combinations of the Landsat OLI/TIRS bands for analysis of land surface types on the images, as shown in Figures \ref{fig07}, \ref{fig08} and \ref{fig09}.
