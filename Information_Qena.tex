...
As a result of the geologic evolution, the geomorphology of the Qena Bend region present a plateau largely dissected by numerous valleys of wadi and geologic lineaments which dissect the cliffs of the Nile River and basement plateau composed of the limestone and chalks \cite{BANDEL1987427}. This result in a specific geomorphic pattern of the Qena Bend surroundings which is notable for a complex drainage network of wadi aquifer systems \cite{Alkholy,AbdelMoneim,HUSSIEN201773}. Such drainage network present a typical feature of the Eastern Desert which consist of numerous fluvial basins that drain the rainwater during flash events towards the Nile River or to the Red Sea \cite{Abdel}.
