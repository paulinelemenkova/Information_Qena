...
\makebox[1.00\linewidth][r]{%
	...
	\begin{subfigure}[b]{.40\textwidth}
		...
		\caption{2022}
	\end{subfigure}%
}\caption{Landsat 8-9 OLI/TIRS images of Qena in natural colour RGB values showing mangrove forests of the  for six years: (\textbf{a}) 2013/12/20, (\textbf{b}) 2015/12/26, (\textbf{c}) 2018/02/21, (\textbf{d}) 2020/01/22, (\textbf{e}) 2021/12/18, (\textbf{f}) 2022/12/29.}\label{fig:03}
\end{figure}
