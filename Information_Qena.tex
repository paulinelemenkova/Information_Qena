...
The results of the clustering include the defined 10 classes best representing the land surface structure and corresponding to the following items modified and generalised from the existing study \cite{Kamel}: \emph{1) Nile River; 2) Floodplain with silts; 3) Wadi deposits; 4) Gritty and gravel soil;  5) Sand soils; 6) Fine sand, silty and clay soil; 7) Gravel and stony soil; 8) Terrace soils and stony debris; 9) Limestone foothills; 10) Limestone rock land}. The Landsat 8-9 OLI/TIRS images were differentiated, and land cover types of the Qena Band region were recognised automatically by R for the years 2013, 2015, 2016, 2019, 2022, and 2023. The statistics on pixels assigned to the classified land cover types based on the spectral signature of the DN of pixels is shown in Table \ref{tab2}. 
...
In this paper, the classified land cover maps were plotted by unsupervised classification of k-means clustering methods and the statistics on pixel assignments is summarise din Tables \ref{tab3}, \ref{tab4} and \ref{tab5}, in order to detect quantitative pairwise comparison of the land cover types in Qena Band region for the years 2013 with 2015, 2016 with 2019, and 2022 with 2023, respectively. The system of Wadi Fluvial structure and drainage stream network in the surroundings of the Qena Bend of the Nile River was identified on the images due to the characteristic morphological structure wit ha typical dendritic pattern that represent the flow direction of the dry wadi streams. Those are largely controlled by the underlying geological structure and regional lithology. The origin of these basins takes place in mountainous highland of the basement and is oriented West-East, either to the Nile or to the Red Sea, according to catchment, therefore their direction is following these orientations. In both cases, the potential damage from the disastrous events may affect urban areas of the small cities and infrastructure of the industrial places. Figure \ref{fig07} shows the wadi streams with their typical dendrite structure, oriented towards the Qena Bend segment of the Nile. 

The area of the Nile floodplain with riparian vegetation has a strong absorption both in visible and NIR Bands, due to the pigmentation of chlorophyll which absorbs highly at wavelength in visible bands. Other factors are the physiological structure of plant canopy and moisture of leaves. Therefore, the floodplain area has a strong reflectance in all bands due to the presence of vegetation wit high water content, as can be seen in Figures \ref{fig07}, \ref{fig08} and \ref{fig09}.
