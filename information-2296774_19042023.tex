...
\centering %% If there is a figure in wide page, please release command \centering
	...
	\end{adjustwidth}
	\caption{\hl{Geologic} %MDPI: Please use periods as decimal signs instead of commas, e.g., "0,10" should be "0.0".
...
\begin{table}[H]
\small
\caption{\hl{Satellite} %MDPI: We removed extra vertical lines, please confirm. Same as all the following tables.
...
%		\newcolumntype{C}{>{\centering\arraybackslash}X}
		\begin{tabularx}{\fulllength}{ p{1.6cm}p{1.8cm}p{7.0cm} p{4.0cm} p{2.0cm} }
			...
			\midrule
			\hl{2013/11/16} %MDPI: we suggest use the format like 'Day Month Year', for example, `16 November 2013`, please check and revise the whole paper.
 & Landsat 8 & \makecell{LC08\_L2SP\_175042\_20131116\_20200912\_02\_T1} & LC81750422013320LGN01 & 0.89 \\
			\hl{2015/11/22} & Landsat 8 & \makecell{LC08\_L2SP\_175042\_20151122\_20200908\_02\_T1} & LC81750422015326LGN01 & 0.05 \\
			\hl{2016/11/08} & Landsat 8 & \makecell{LC08\_L2SP\_175042\_20161108\_20200905\_02\_T1} & LC81750422016313LGN01 & 0.31 \\
			\hl{2019/11/17} & Landsat 8 & \makecell{LC08\_L2SP\_175042\_20191117\_20200825\_02\_T1} & LC81750422019321LGN00 & 1.16 \\
			\hl{2022/11/09} & Landsat 8 & \makecell{LC08\_L2SP\_175042\_20221109\_20221121\_02\_T1} & LC81750422022313LGN00 & 0.02 \\
			\hl{2023/01/20} & Landsat 9 & \makecell{LC09\_L2SP\_175042\_20230120\_20230122\_02\_T1} & LC91750422023020LGN01 & 0.32 \\	
			\bottomrule
		\end{tabularx}
	\end{adjustwidth}
...
\makebox[1.00\linewidth][r]{%
	...
	\end{subfigure}%
}\caption{Qena Bend of the Nile River, Egypt, visible on Landsat 8-9 OLI/TIRS images in natural RGB color for six years: (\textbf{a}) \hl{2013/12/20}%MDPI: we suggest use the format like 'Day Month Year', for example, `16 November 2013`, please check and revise the whole paper.
, (\textbf{b}) \hl{2015/12/26}, (\textbf{c}) \hl{2018/02/21}, (\textbf{d}) \hl{2020/01/22}, (\textbf{e}) \hl{2021/12/18}, (\textbf{f}) \hl{2022/12/29}.}\label{fig05}
\end{figure}
...
Specifically, the workflow included the following steps (the examples below are given for the image from 2013 and repeated for all the images, respectively). First, the images were read in to the RStudio environment as a stack of {TIFF images (}.tif files{) }using the R command \hl{\emph{Landsat2013 <- list.files()}}%MDPI: Please confirm if the italics is unnecessary and can be removed. please check the whole paper.
...
\small
\caption{\hl{Results}
 of the k-means classification of the Landsat-8 OLI images for Qena Bend area \textsuperscript{1}.\label{tab2}}
	\begin{adjustwidth}{-\extralength}{0cm}
...
\small
\caption{\hl{Pairwise} 
 comparison of the k-means classification for Bands 5-4-3 of the Landsat-8 OLI/TIRS images for 2013 and 2015 in Qena Bend region \textsuperscript{1}.\label{tab3}}
	\begin{adjustwidth}{-\extralength}{0cm}
		\begin{tabularx}{\fulllength}{CCCCCCC}
			\toprule
			\multirow{2}{*}{\textbf{\emph{\hl{Class ID} %MDPI: Please check if the italics in table header is necessary, if not, please remove.
}}} & \multicolumn{3}{c}{\textbf{2013}} & \multicolumn{3}{c}{\textbf{2015}} \\ 
			\textbf{} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} \\
			\midrule
...
\begin{table}[H]
\small
\caption{\hl{Pairwise} comparison of the k-means classification for Bands 5-4-3 of the Landsat-8 OLI/TIRS images for 2016 and 2019 in Qena Bend region \textsuperscript{1}.\label{tab4}}
	\begin{adjustwidth}{-\extralength}{0cm}
		\begin{tabularx}{\fulllength}{CCCCCCC}
			\toprule
			\multirow{2}{*}{\textbf{\emph{Class ID}}} & \multicolumn{3}{c}{\textbf{2016}} & \multicolumn{3}{c}{\textbf{2019}} \\
			\textbf{} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} \\
			\midrule
...
\begin{table}[H]
\small
\caption{\hl{Pairwise} comparison of the k-means classification for Bands 5-4-3 of the Landsat-8 OLI/TIRS images for 2022 and 2023 in Qena Bend region \textsuperscript{1}.\label{tab5}}
	\begin{adjustwidth}{-\extralength}{0cm}
		\begin{tabularx}{\fulllength}{CCCCCCC}
			\toprule
			\multirow{2}{*}{\textbf{\emph{Class ID}}} & \multicolumn{3}{c}{\textbf{2022}} & \multicolumn{3}{c}{\textbf{2023}} \\ 
			\textbf{} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} & \textbf{\emph{Band 5}} & \textbf{\emph{Band 4}} & \textbf{\emph{Band 3}} \\
			\midrule
...
Figure \ref{fig09} visualizes the band combinations {6-3-1, 5-4-3, 5-6-2, and 7-5-3} for the images covering the Qena region in 2022 and 2023. 
...
The composite of {5-4-3 }includes the NIR, Red, and Green bands that best represent the vegetation coverage in the Nile River floodplain, which is identified as dark crimson, well {contrasted }against the other land cover types. 
...
\newblock In Proceedings of the IGARSS 2003. 2003 IEEE International Geoscience
  and Remote Sensing Symposium. Proceedings (IEEE Cat. No.03CH37477),  \hl{Toulouse, France, 21--25 July 2003;} %MDPI: We added the location and date of the conference. Please confirm. same as below.
...
\newblock In Proceedings of the IGARSS'97. 1997 IEEE International Geoscience
  ...
  Vision for Sustainable Development,  \hl{Singapore, 3--8 August 1997;} Volume~1, \mbox{pp. 197--199}.
...
\newblock In Proceedings of the IGARSS '96. 1996 International Geoscience and
  Remote Sensing Symposium, \hl{Lincoln, NE, USA, 31 May 1996;} Volume~3, pp. 1756--1758.
...
\newblock In Proceedings of the 2013 IEEE International Geoscience and Remote
  Sensing Symposium---IGARSS, \hl{Melbourne, VIC, Australia, 21--26 July 2013;} pp. 3594--3597.
...
\newblock In Proceedings of the 2012 IEEE International Geoscience and Remote
  Sensing Symposium, \hl{Munich, Germany, 22--27 July 2012;} \mbox{pp. 2683--2686}.
...
\newblock In Proceedings of the 2020 12th International Conference on
  Electrical Engineering (ICEENG), \hl{Cairo, Egypt, 7--9 July 2020;} \mbox{pp. 293--297}.
...
\newblock In Proceedings of the IGARSS 2019---2019 IEEE International
  Geoscience and Remote Sensing Symposium, \hl{Yokohama, Japan,   28 July--2 August  2019;} \mbox{pp. 1--4}.
...
\newblock In Proceedings of the 2018 10th IAPR Workshop on Pattern Recognition
  in Remote Sensing (PRRS),  \hl{Beijing, China, 19--20 August 2018;} \mbox{pp. 1--13}.
...
\newblock In Proceedings of the 2007 International Conference on Wavelet
  Analysis and Pattern Recognition, \hl{Beijing, China, 2--4 November  2007;} Volume~1, pp. 321--325.
...
Said, R.
\newblock {\em The geology of Egypt}; Routledge: \hl{New York, NY, USA,} %MDPI: We added the location of the publisher. Please confirm.
  2017.
...
\newblock 10---Data clustering using unsupervised machine learning. In {\em
  ...
  Academic Press: \hl{Cambridge, MA, USA,} %newly added information, please confirm
  2023; pp. 179--204.
...
\newblock Chapter 11---Cluster analysis. In {\em Data Science, Analytics and
  ...
  R., Eds.; Academic Press:  \hl{Cambridge, MA, USA,} %newly added information, please confirm
  2023; pp. 193--201.
...
\newblock In Proceedings of the 2018 4th International Symposium on
  Geoinformatics (ISyG),  \hl{Malang, Indonesia, 10--12 November 2018;} pp. 1--5.
...
Curran, P.J.
\newblock {\em Principles of Remote Sensing}; Longman Inc.: \hl{Harlow, UK, } %MDPI: We added the location of the publisher. Please confirm.
 1985.
...
\newblock In Proceedings of the 2007 National Radio Science Conference,  \hl{Cairo, Egypt, 13--15 March 2007;}
  \mbox{pp. 1--10.}
